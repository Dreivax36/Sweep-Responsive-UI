...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                <li><a class="active nav_con" href="#">Home</a></li>
                <li><a class="nav_con" href="#">Services</a></li>
                <li><a class="nav_con" href="#">Contact Us</a></li>
                <li><a class="nav_con" href="#">FAQs</a></li>
                <li><a class="nav_con" href="#">About Us</a></li>
                <div class="login_con">
