...
Route::group(['middleware'=>['AuthCheck']], function(){
    ...
    Route::get('/customer/login',[MainController::class, 'customer_login'])->name('customer.customer_login');
    Route::get('/customer/register',[MainController::class, 'customer_register'])->name('customer.customer_register');
    ...
    Route::get('/cleaner/login',[MainController::class, 'cleaner_login'])->name('cleaner.cleaner_login');
    Route::get('/cleaner/register',[MainController::class, 'cleaner_register'])->name('cleaner.cleaner_register');
    Route::get('/cleaner/dashboard',[MainController::class, 'cleaner_dashboard'])->name('cleaner.cleaner_dashboard');
